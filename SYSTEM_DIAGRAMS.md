...
| Permission | MINISTRY | ADMIN | FINANCE | CONTENTIEUX | URBANISM | INSPECTOR | AGENT | CITIZEN | BUSINESS |
|------------|----------|-------|---------|-------------|----------|-----------|-------|---------|----------|
| **View National Dashboard** | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ |
| **Approve Budgets** | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ |
| **View All Communes** | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ |
| **Manage Municipality Config** | ❌ | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ |
...
## 3. API Architecture - RESTful Endpoints by Resource
...
| Category | Endpoint Count | Authentication | Key Features |
|----------|----------------|----------------|--------------|
| **Public** | 5 | None | Tax calculator, tariffs, commune info |
| **Authentication** | 9 | Mixed | Login, register, 2FA, profile |
| **TIB (Properties)** | 25+ | Required | CRUD properties, tax calculation, renewal |
| **TTNB (Lands)** | 22+ | Required | CRUD lands, tax calculation, renewal |
| **Payments** | 18+ | Required | Pay, history, receipts, installment plans |
| **Permits** | 12+ | Required | Request, review, approve/reject |
| **Inspections** | 15+ | Inspector only | Field visits, satellite verification |
| **Disputes** | 10+ | Mixed | File, review, resolve |
| **Reclamations** | 8+ | Mixed | Submit, review, approve |
| **Exemptions** | 10+ | Required | Request, approve, manage |
| **Finance** | 12+ | Finance role | Debtors, reports, manual payments |
| **Municipal Admin** | 15+ | Admin only | Dashboard, config, user management |
| **Ministry** | 8+ | Ministry only | National dashboard, budget voting |
| **Search & Reports** | 10+ | Required | Advanced search, export, analytics |
| **Documents** | 6+ | Required | Upload, download, manage |
...
**System:** TUNAX - Tunisian Municipal Tax Management System  
**Version:** 1.0.0
